                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <div class="row">
                                <div class="col-md-4">
                                    <img src="images/partner_logo_dark_1.png" class="d-block w-50" alt="...">
                                </div>
                                <div class="col-md-4">
                                    <img src="images/partner_logo_dark_3.png" class="d-block w-50" alt="...">
                                </div>
                                <div class="col-md-4">
                                    <img src="images/partner_logo_dark_4.png" class="d-block w-50" alt="...">
                                </div>
